...
author:            fangzheng
---
The features described in this section are specific for this template. All other language features can be found in the [kramdown documentation][1]. 
...
More formating features can be found in the [Kramdown syntax][2].
